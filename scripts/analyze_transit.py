"""Transit-window analysis of a real TESS SPOC light curve for WASP-12 b.
...
DATA_FILE = DATA_DIR / "tess2019357164649-s0020-0000000086396382-0165-s_lc.fits"
PLANET = "WASP-12 b"
PERIOD_DAYS = 1.091418901
EPOCH_BJD = 2457607.519305
DURATION_HOURS = 3.001
SECTOR = 20
FIGURE_FILE = FIG_DIR / "wasp12b_tess_transit.png"
...
def main() -> dict[str, float]:
    ...
    ax.scatter(hours, (result["flux"] - 1) * 1e6, s=5, alpha=0.12, color="#e67700", label="quality-filtered cadences")
    ...
    ax.plot(hours[order], (result["model"][order] - 1) * 1e6,
            color="#e67700", linewidth=2.2, label="fitted box model")
    ax.axvspan(-DURATION_HOURS / 2.0, DURATION_HOURS / 2.0, color="#e67700", alpha=0.08)
