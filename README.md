...
|---|---:|
| TESS sector | 20 |
| Cadences in comparison | 9498 |
| Fitted box depth | 12579.0 ± 105.3 ppm |
| Flat χ² / dof / p | 18703.88 / 9497 / < 1e-300 |
| Box χ² / dof / p | 4428.10 / 9496 / 1.0000 |
| Improvement Δχ² / Δdof / p | 14275.77 / 1 / < 1e-300 |
...
The fixed archive ephemeris was fitted independently in 3 usable sector(s) (S20, S43, S45). Formal depth errors were inflated by sqrt(max(reduced chi-square, 1)) times the residual time-averaging beta factor (observed range 2.24-2.44). The robust inverse-variance depth is 12308.1 +/- 108.8 ppm; Cochran Q = 1.91 for 2 dof (p = 0.3848). These scaled errors address underestimated scatter and short-timescale correlation, but they are not a full Gaussian-process or physical limb-darkened transit fit.
